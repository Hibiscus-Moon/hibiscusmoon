<?php $canadaterms = get_terms( array(
	...
	<div class="accordian fusion-accordian">
		<div class="panel-group" id="accordion-22222-2">
			...
			<div class="fusion-panel panel-default fusion-toggle-no-divider fusion-toggle-boxed-mode">
				<div class="panel-heading">
					<h4 class="panel-title toggle">
						<a data-toggle="collapse" data-parent="#accordion-22222-2" data-target="#<?php echo $panelnumber; ?>" href="#<?php echo $panelnumber; ?>" class="active">
