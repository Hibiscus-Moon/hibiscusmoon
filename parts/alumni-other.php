<?php $otherterms = get_terms( array(
	...
	<div class="accordian fusion-accordian">
		<div class="panel-group" id="accordion-99999-9">
		<?php foreach ( $otherterms as $term ) { ?>
			...
			<div class="fusion-panel panel-default fusion-toggle-no-divider fusion-toggle-boxed-mode">
				<div class="panel-heading">
					<h4 class="panel-title toggle">
						<a data-toggle="collapse" data-parent="#accordion-99999-9" data-target="#<?php echo $panelnumber; ?>" href="#<?php echo $panelnumber; ?>" class="active">
